...
export default function MultiDropDownInput(props: {
  id: number;
  title: string;
  options: string[];
  value: string;
  ...
  setMOptionsValueCB: (id: number, options: string[]) => void;
}) {
  return (
    <div>
      ...
      <div className="flex gap-2">
        <div className="flex flex-col w-full">
          ...
          <input
            ...
            onChange={(e) => {
              props.setMOptionsValueCB(props.id, e.target.value.split(","));
            }}
            type="text"
          />
        </div>
